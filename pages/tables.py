...
class Tables(BasePage): # Создаём класс Tables, наследуемый от класса BasePage
    ...
    def __init__(self, driver): # добавляем конструктор, принимающий аргумент driver
        ...
        self.column_first_name = WebElement(driver, 'div.rt-th:nth-child(1)')
        self.column_last_name = WebElement(driver, 'div.rt-th:nth-child(2)')
        self.column_age = WebElement(driver, 'div.rt-th:nth-child(3)')
        self.column_email = WebElement(driver, 'div.rt-th:nth-child(4)')
        self.column_salary = WebElement(driver, 'div.rt-th:nth-child(5)')
        self.column_department = WebElement(driver, 'div.rt-th:nth-child(6)')
        self.column_action = WebElement(driver, 'div.rt-th:nth-child(7)')